...
public class OrderConfirmedPage extends BasePage {
    ...
    @FindBy(css = ".cart-engrave-letter")
    private WebElement lblAddedEngraveLetter;
...
//        switchToDefaultContent();
    ...
    public void verifyAddedEngraveLetter(){
        waitForElementVisible(lblAddedEngraveLetter);
        // Assert that the label is displayed
        Assert.assertTrue("Engrave letter added is displayed", lblAddedEngraveLetter.isDisplayed());

        // Assert that the text matches the expected message
        String expectedMessage = "Engraved letter \"" + BasePage.engraveLetter + "\"";
        String actualMessage = lblAddedEngraveLetter.getText();
