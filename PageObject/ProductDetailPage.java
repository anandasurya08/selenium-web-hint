...
public class ProductDetailPage extends BasePage {
    ...
    @FindBy(xpath = "//button[contains(text(),'Engrave Now')]")
    private WebElement btnEngraveFromProductDetail;
    ...
    public void openEngraveFromProductDetail(){
        waitForElementClickable(btnEngraveFromProductDetail);
        click(btnEngraveFromProductDetail);
    }
